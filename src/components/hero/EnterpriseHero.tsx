  ...
  return (
    <section className="relative pt-24 pb-12 sm:pt-32 sm:pb-16 lg:pt-36 lg:pb-24 overflow-hidden bg-slate-950 text-white border-b border-white/10 transition-colors duration-200">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/75 via-black/40 to-black/85 transition-opacity duration-300" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-5 mb-8 sm:mb-10">
          {/* Top Pill Badge */}
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-[52px] font-extrabold tracking-tight text-white drop-shadow-lg leading-[1.18] sm:leading-[1.15]">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-slate-200 drop-shadow-md leading-relaxed max-w-2xl mx-auto font-normal px-2">
          ...
          {/* Key Proof Points */}
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-[11px] sm:text-xs text-slate-300 font-medium drop-shadow">
          ...
          {/* Interactive Background Video Switcher Bar - Mobile Optimized Scrollable Pill */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-5 mt-6 sm:mt-8">
